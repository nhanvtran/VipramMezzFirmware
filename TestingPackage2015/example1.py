...
def exampleTest(filename):
	...
	for i in range(30): inputPattern.checkPattern( [37,37,37,37] ,9);
	inputPattern.doRowChecker(9);    
...
#########################################################
#########################################################
def stressTest(filename, N, freq, odir, loadMode):
	...
	# inputP.initializeRunPhase_Mod([1, 0, 0, 0],51,[16384,16384,16384,16384]);
